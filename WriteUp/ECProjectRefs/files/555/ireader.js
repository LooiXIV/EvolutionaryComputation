...
window._colwizStylesPath_ = {
    "webpdf/button-chrome.css": "webpdf/button-chrome.20ed97784c0c9af4b03ffd20c421cfa2.css",
    "webpdf/button-web.css": "webpdf/button-web.20ed97784c0c9af4b03ffd20c421cfa2.css",
    "webpdf/csl.css": "webpdf/csl.69209f314e43fb29c2ca53c41a992868.css",
    "webpdf/popup-chrome.css": "webpdf/popup-chrome.056fd7e4bbddf788932a9e6f7bac5cc4.css",
    "webpdf/reader-chrome.css": "webpdf/reader-chrome.bcc837f06eb20fd50494473929e03ebe.css",
    "webpdf/reader-desktop.css": "webpdf/reader-desktop.bcc837f06eb20fd50494473929e03ebe.css",
    "webpdf/reader-web.css": "webpdf/reader-web.bcc837f06eb20fd50494473929e03ebe.css"
};
var CwZ, CwH;
var cPDF = {
    initErrors: [],
	...
	assetsDomainURL: "cdn.colwiz.com/assets",
	version: "17.06.07-2470-175",
    initialized:false,
    js: [
    ...
    init: function() {
        ...
        try {
            ...
            if (bHTML5Support && !isMobile && isIE10) {
                ...
                cPDF.loadJs(0);
                cPDF.addCSS("css/"+window._colwizStylesPath_['webpdf/button-web.css']);
            } else {
    ...
    addCSS: function(path) {
        try {
            ...
            var filename;
            if(cPDF.assetsDomainURL.indexOf("http")>=0)
                filename = cPDF.assetsDomainURL + "/" + path;
            else
                filename = ('https:' === document.location.protocol ? 'https://' : 'http://') + cPDF.assetsDomainURL + "/" + path;
