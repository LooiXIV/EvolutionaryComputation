...
# Make the Plot
############################################
algoNames = ["NSGAII", "SPEA2", "DE", "CMAES", "Nelder-Mead"]
...
for axes, sig in zip(Allaxes, ChDataDict.keys()):
    ...
    allParamsEsts = [parmsNSGAII, parmsSPEA2, parmsDE, parmsCM, parmsLB]
    algoFig = {}
...
plt.savefig("Figures/RepPlotsRealDataWCMEAS.png", dpi=300)
plt.show()
